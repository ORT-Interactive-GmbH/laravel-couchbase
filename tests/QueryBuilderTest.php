...
class QueryBuilderTest extends TestCase
{
    ...
    public function testGet()
    {
        ...
        DB::table('users')->key('users::john_doe')->insert(['name' => 'John Doe']);
    ...
    {
        DB::table('users')->key('users::tags')->insert([
            'tags' => ['tag1', 'tag2'],
            'name' => 'John Doe',
        ]);
    ...
    public function testInsertGetId()
    {
        ...
        $id = DB::table('users')->key('foobar')->insertGetId(['name' => 'John Doe']);
        $this->assertSame('foobar', $id);
    }

    public function testBatchInsert()
    {
        DB::table('users')->key('batch')->insert([
            [
                'tags' => ['tag1', 'tag2'],
                'name' => 'Jane Doe',
            ],
    ...
    {
        $id = 'my_id';
        DB::table('users')->key($id)->insert(['name' => 'John Doe']);
    ...
    {
        DB::table('users')->key('users.1')->insert(['name' => 'Jane Doe']);
        DB::table('users')->key('users.2')->insert(['name' => 'Jane Doe']);
    ...
    public function testUpdate()
    {
        ...
        DB::table('users')->key('users.1')->insert(['name' => 'John Doe', 'age' => 30]);
        DB::table('users')->key('users.2')->insert(['name' => 'Jane Doe', 'age' => 20]);
    ...
    public function testDelete()
    {
        ...
        DB::table('users')->key('users.1')->insert(['name' => 'John Doe', 'age' => 25]);
        DB::table('users')->key('users.2')->insert(['name' => 'Jane Doe', 'age' => 20]);
    ...
    {
        DB::table('users')->key('john')->insert(['name' => 'John Doe']);
        DB::table('users')->truncate();
    ...
    {
        DB::table('users')->key('users.1')->insert([
            'name'    => 'John Doe',
            'address' => ['country' => 'Belgium', 'city' => 'Ghent'],
        ]);
        DB::table('users')->key('users.2')->insert([
            'name'    => 'Jane Doe',
    ...
    {
        DB::table('items')->key('items.1')->insert([
            'tags' => ['tag1', 'tag2', 'tag3', 'tag4'],
        ]);
        DB::table('items')->key('items.2')->insert([
            'tags' => ['tag2'],
        ]);
    ...
    {
        DB::table('items')->key('item:1')->insert(['name' => 'knife', 'type' => 'sharp']);
        DB::table('items')->key('item:2')->insert(['name' => 'fork',  'type' => 'sharp']);
        DB::table('items')->key('item:3')->insert(['name' => 'spoon', 'type' => 'round']);
        DB::table('items')->key('item:4')->insert(['name' => 'spoon', 'type' => 'round']);
    ...
    public function testTake()
    {
        ...
        DB::table('items')->key('item.'.uniqid())->insert(['name' => 'knife', 'type' => 'sharp', 'amount' => 34]);
        DB::table('items')->key('item.'.uniqid())->insert(['name' => 'fork',  'type' => 'sharp', 'amount' => 20]);
        DB::table('items')->key('item.'.uniqid())->insert(['name' => 'spoon', 'type' => 'round', 'amount' => 3]);
        DB::table('items')->key('item.'.uniqid())->insert(['name' => 'spoon', 'type' => 'round', 'amount' => 14]);
    ...
    {
        DB::table('users')->key('user.1')->insert(['name' => 'Jane Doe', 'age' => 20]);
        DB::table('users')->key('user.2')->insert(['name' => 'John Doe', 'age' => 25]);
