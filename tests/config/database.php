...
return [
    'connections' => [
        'couchbase-default' => strpos(env('CB_VERSION', '4'), '4') === 0 ? [
            'name' => 'couchbase',
            'driver' => 'couchbase',
            'port' => env('CB_PORT', 8091),
            'host' => env('CB_HOST', '127.0.0.1'),
            'bucket' => env('CB_DATABASE', env('CB_BUCKET', 'test-ing')),
            'database' => env('CB_DATABASE', env('CB_BUCKET', 'test-ing')),
            'user' => env('CB_USER', env('CB_USERNAME')),
            'password' => env('CB_PASSWORD'),
            'n1ql_hosts' => ['http://127.0.0.18093'],
            'inline_parameters' => env('CB_INLINE_PARAMETERS_DEFAULT_BUCKET', env('CB_INLINE_PARAMETERS', false)),
        ] : [
            'name' => 'couchbase',
            'driver' => 'couchbase',
        ...
        'couchbase-not-default' => strpos(env('CB_VERSION', '4'), '4') === 0 ? [
            'name' => 'couchbase',
            'driver' => 'couchbase',
            'port' => env('CB_PORT', 8091),
            'host' => env('CB_HOST', '127.0.0.1'),
            'bucket' => env('CB_DATABASE', env('CB_BUCKET', 'test-ing')).'2',
            'database' => env('CB_DATABASE', env('CB_BUCKET', 'test-ing')).'2',
            'user' => env('CB_USER', env('CB_USERNAME')),
            'password' => env('CB_PASSWORD'),
            'n1ql_hosts' => ['http://127.0.0.18093'],
